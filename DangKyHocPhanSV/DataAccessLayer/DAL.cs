...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        string strConnect = "Data Source = MSI; Initial Catalog = QUANLYSV; Integrated Security = True";

        public void changeStrConnectToSinhVien()
        {
            strConnect = "Data Source = MSI; Initial Catalog = QUANLYSV; Persist Security Info = True; User ID = sinhvien; Password = sinhvien";
        ...
        {
            strConnect = "Data Source = MSI; Initial Catalog = QUANLYSV; Persist Security Info = True; User ID = giangvien; Password = giangvien";
            cnn = new SqlConnection(strConnect);
            cmd = cnn.CreateCommand();
        }
